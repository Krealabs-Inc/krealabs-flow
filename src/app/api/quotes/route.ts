...
import { listQuotes, createQuote } from "@/lib/services/quote.service";
import { createQuoteSchema } from "@/lib/validators/quote.validator";
...
export async function POST(request: NextRequest) {
  ...
  try {
    const quote = await createQuote(parsed.data, DEFAULT_ORG_ID, user.id);
